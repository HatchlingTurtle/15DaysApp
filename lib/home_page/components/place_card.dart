            ...
            child: Container(
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                    image: AssetImage(eventSpot.image), fit: BoxFit.cover),
              ),
            ),
          ),
          Container(
            ...
            child: Column(
              children: [
                ...
                if (isFullCard)
                  Text(
                    DateFormat.MMMM().format(eventSpot.date) +
                        " " +
                        eventSpot.date.year.toString(),
                  ),
                VerticalSpacing(of: 10),
                Travelers(
                  users: eventSpot.users,
                ),
              ],
            ),
          )
